...
class ToggleParticipationUseCase {
  final EventRepository repository;

  ToggleParticipationUseCase(this.repository);

  Future<Event> call(int eventId) async {
    return repository.toggleParticipation(eventId);
  }
}
